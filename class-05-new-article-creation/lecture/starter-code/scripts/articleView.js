...
articleView.create = function() {
  ...
  var formArticle = new Article({
    title: $('#article-title').val(), //we want the value of that element.
  ...
  $('pre code').each(function(i, block) { //i represents this and you can index it. i === 3 then do the following if you want to just target one of the indices.
